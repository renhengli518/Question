var feed = (function () {
	...
	var picDetail = (function () {
		...
		var $photoDetail, $detailBox, $photoBox, $image, $preBtn, $nextBtn, $title;
	...
	var feedList = function ($list) {
		...
		return {
			...
			feedReply: function ($elm) {
				...
				$.post(KD_RRT.root + "/front/dynamicComment/sendDynamicComment.do", {"content":content,"dynamicId": feedId,"basedUserId":basedUserId,"atName":atName}, function (data) {
					$feedItem.find('.commentList').prepend(replyListTmp({data: data, text2HTML: util.smile.text2HTML, hasMoreReply: false, hasFirstReply: false}));
